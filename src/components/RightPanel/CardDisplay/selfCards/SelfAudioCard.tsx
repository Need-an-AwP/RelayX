...
import { useAudioProcessing, usePeerStateStore, useDesktopCapture } from "@/stores"
import UserAudioSpectrum from "@/components/UserAudioSpectrum";


export default function SelfAudioCard({ isMaximized, className, idKey, onClick }: { isMaximized: boolean, className?: string, idKey?: number, onClick?: () => void }) {
        ...
        <ContextMenu>
            <ContextMenuTrigger>
                <Card
                    ...
                    ${isMaximized ? 'absolute inset-0 top-1/2 -translate-y-1/2 rounded-none hover:ring-0 border-none' :
                        ...
                        <>
                            <div className="h-full w-full">
                                ...
                                <div className={`absolute top-2 left-2 w-[6%] aspect-square z-10 opacity-0 
                                    ${isMaximized ? 'group-hover:opacity-100' : ''}
            ...
            <ContextMenuContent>
                <ContextMenuItem onClick={() => {
                    ...
                    {isDisplayingAvatar ? 'Stop displaying avatar' : 'Display avatar'}
                </ContextMenuItem>
