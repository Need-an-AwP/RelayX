...
import { useMessageStore, usePeerStateStore, type peerIP } from "@/stores";
...
export default function MessageInput({ onFocusChange }: MessageInputProps) {
    ...
    const [targetPeers, setTargetPeers] = useState<peerIP[]>([]);
    const [finalTargetPeers, setFinalTargetPeers] = useState<peerIP[]>([]);
    ...
    const lastMessageIdRef = useRef<Record<peerIP, string>>({});
