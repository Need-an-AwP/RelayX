...
const AvatarSelector = ({ currentAvatar, onAvatarChange }: { currentAvatar: string, onAvatarChange: (avatar: string) => void }) => {
    ...
    return (
        <>
            ...
            <Popover>
                ...
                <PopoverContent side="right" className="w-96 m-8 z-50 overflow-hidden" >
                        ...
                        <div className="flex items-center justify-center gap-2 w-full">
                            ...
                            <PopoverClose disabled={!avatarURLInput}>
                                <Button
                                    ...
                                    onClick={() => { onAvatarChange(avatarURLInput) }}>
