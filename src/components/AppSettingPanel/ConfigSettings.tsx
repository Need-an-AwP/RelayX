...
export default function ConfigSettings() {
    const [isClickEffectEnabled, setIsClickEffectEnabled] = useState(true)
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <Label className="text-sm font-medium">Click Effect</Label>
                            </div>
                            <Badge variant="outline" className="text-xs">Effect</Badge>
                        </div>
                        <div className="text-xs text-muted-foreground mb-2">
                            Turn on/off click animation effect
                        </div>
                        <div className="flex justify-end">
                            <Switch 
                                disabled={true} 
                                checked={isClickEffectEnabled} 
                                onCheckedChange={setIsClickEffectEnabled} 
                            />
                        </div>
                    </div>
                </Card>
